...
def index():
    if request.method == 'POST':
        try:
            ...
            bigboxes = flipkart_html.findAll("div", {"class": "_75nlfW"})
            del bigboxes[0:3]
            box = bigboxes[0]
            ...
            print(prod_html)
            commentboxes = prod_html.find_all('div', {'class': "ZmyHeo"})
            ...
            client = pymongo.MongoClient("mongodb+srv://mymongodb:Test@2024@cluster0.uammhmq.mongodb.net/?retryWrites=true&w=majority")
